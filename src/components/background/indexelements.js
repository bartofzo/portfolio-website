...
{
    constructor(triangleSet, page, screenRect, markCallback)
    {
        ...
        const adjustedScreenRect = page.smallIndex ? {...screenRect, bottom : screenRect.bottom / 2 } : screenRect;
        ...
        this.largestTriangles = triangleSet.getSortedByBoundingRectArea(triangle => 
            !triangle.outer && 
            !triangle.inner && 
            triangle.fullyInRectNoOffset(adjustedScreenRect));
